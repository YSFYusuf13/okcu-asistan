...
#1. SAYFA YAPILANFIRMASI
st.set_page_config(
page_title="Emir Hoca'nın Asistanı",
page_icon="🏹",
layout="wide",
initial_sidebar_state="expanded"
)
#2. TEMA VE SPORCU KLASÖRÜ SEÇİMİ(SİDEBAR)
st.sidebar.title("​🎨 Tema & Ayarlar")
selected_theme = st.sidebar.selectbox(
    "Renk Modu" ,
    ["Altın & Bordo", "GS Özel", "Gece Mavisi", "Karanlık Mod"]
     )
themes = {
...
# YENİ: SPORCU YÖNETİMİ & KLASÖR SİSTEMİ
st.sidebar.divider()
...
with col1:
    with st.container(border=True):
            ...
            # YENİ: PUANLAMA KAĞIDINA ÖZEL NOT ALANI
             st.markdown("---")
 ...
 with col2:
     with st.container(border=True):
      ...
      st.warning("Ses kaydı için Streamlit sürümünüzü güncelleyin.")